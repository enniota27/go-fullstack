...
const app = require('./app'); //Importer la constance app du fichier app.js

const normalizePort = val => { //Renvoie un port valide sous forme d'un numéro ou d'une string
...
app.set('port', port); //Permet de dire à l'appli express sur quel port elle va tourné
